...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sellItem(camsBasket, "a wrench", 5);
        ...
        removeItem(camsBasket, "car", 1);
        System.out.println("cars removed: " + removeItem(camsBasket, "car", 1));
        ...
        // can't add items to stockList this way, need to use methods we set up
